  ...
  () => {
    ...
    function s(t) {
      ...
      const e = () => {
        ...
        t.set = function (e, s) {
          '' === e ? e = t.largestIndex++ : /^[0-9]+$/.test(e) &&
          (e = parseInt(e), t.largestIndex <= e && (t.largestIndex = e + 1)),
      ...
      i]of this.formData) {
        const n = t.match(s);
        if (n) if ('' === n.groups.array) this.tree.set(n.groups.name, i);
         else {
          const t = [
    ...
    s.prototype.getAll = function (t) {
      ...
      const e = t => {
        const s = [];
        if (t instanceof Map) for (const [i,
        n]of t) s.push(...e(n));
         else '' !== t &&
        s.push(t);
        return s
      ...
      if (
        !t.getAll(this.field).every(
          (
            ...
            this.accept?.some(
              (
                e => /^\.[a-z0-9]+$/i.test(e) ? t.name.toLowerCase().endsWith(e.toLowerCase()) : (
                  t => {
                    const e = [],
    ...
    h = function (t) {
      if (
        !t.getAll(this.field).every((t => this.accept?.some((e => t === String(e)))))
      ) throw new n(this)
    },
    u = function (t) {
      if (
    ...
    g = function (t) {
      if (t.getAll(this.field).length < parseInt(this.threshold)) throw new n(this)
    },
    v = function (t) {
      const e = t.getAll(this.field);
    ...
    y = function (t) {
      if (
        !t.getAll(this.field).every((t => !(parseFloat(t) < parseFloat(this.threshold))))
      ) throw new n(this)
    },
    b = function (t) {
      if (
        !t.getAll(this.field).every((t => !(parseFloat(this.threshold) < parseFloat(t))))
      ) throw new n(this)
    },
    A = function (t) {
      if (
