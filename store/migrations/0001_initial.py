    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', django.contrib.postgres.fields.ArrayField(base_field=models.ImageField(upload_to='your_image_folder/'), size=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordered_items', to='store.product')),
            ],
        ),
        migrations.AddField(
            model_name='user',
